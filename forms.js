! function (e) {
    ...
    function n() {
        function e(e, t) {
            return new a.InfoObject(e, "FORM INFO")
        }(0, u.addPolyfills)();
        var t = [{
                selector: "button",
                color: "purple",
            ...
            n = {
                appName: "Forms",
                cssClass: (0, i.getCssClass)("Forms"),
                msgText: "No form-related elements found: <ul>" + r + "</ul>",
                targetList: t,
                getInfo: e,
                dndFlag: !0
            };
        ...
        switch (e.nodeType) {
            case Node.ELEMENT_NODE:
                if (a(e)) r = o(e, "alt");
                    ...
                    for (var i = e.childNodes, u = [], c = 0; c < i.length; c++) {
                        var m = l(i[c], t);
                        m.length && u.push(m)
                    }
                    r = u.length ? u.join(" ") : ""
    ...
    } /**Functions d, f, b, p, g, h and v are responsible for creating values for info pop-up. */
    function d(e, t) {
        var r = void 0;
    ...
    var y = r(10);
    t.normalize = n, t.getAttributeValue = o, t.hasEmptyAltText = i, t.isLabelableElement = u, t.getElementContents = c, t.nameFromAttribute = d, t.nameFromAltAttribute = f, t.nameFromContents = b, t.nameFromDefault = p, t.nameFromDescendant = g, t.nameFromLabelElement = h, t.nameFromDetailsOrSummary = v
}, function (e, t, r) {
    "use strict";
    ...
    function a(e) {
        ...
        switch (t) {
            ...
            case "input":
                ...
                if ("div" === r) return e.hasAttribute("list") ? "combobox" : "textbox";
                break;
            case "li":
        ...
        return t.forEach(function (e) {
            ...
            "function" == typeof e.filter && (t = Array.prototype.filter.call(t, e.filter)), Array.prototype.forEach.call(t, function (t) {
                if (n(t)) {
                    ...
                    var f = d.firstChild;
                    f.title = (0, c.formatInfo)(s), document.body.appendChild(d), u += 1
                }
            })
        }), u
    }
    ...
    var l = r(12),
        c = r(6);
    t.countChildrenWithTagNames = o, t.isDescendantOf = a, t.hasParentWithName = i, t.addNodes = u, t.removeNodes = s
}, function (e, t) {
    "use strict";
    ...
    function n(e) {
        ...
        if (e.hasAttribute("role")) {
            var u = (0, a.getAttributeValue)(e, "role");
            u.length && (r += ' [role="' + u + '"]')
        }
        return r
    }
    ...
    function o(e) {
        ...
        window.addEventListener("resize", function (e) {
            (0, u.removeNodes)(t.cssClass), o.resize(), t.show = !1
    ...
    t.Bookmarklet = o, o.prototype.run = function () {
        ...
        e.hide(), this.show = !this.show, this.show ? 0 === (0, u.addNodes)(this.params) && (e.show(this.appName, this.msgText), this.show = !1) : (0, u.removeNodes)(this.cssClass)
    }
}, function (e, t, r) {
    "use strict";
    ...
    function o(e, t) {
        this.title = t, this.element = (0, i.getElementInfo)(e), this.grpLabels = (0, a.getGroupingLabels)(e), this.accName = (0, a.getAccessibleName)(e), this.accDesc = (0, a.getAccessibleDesc)(e), this.role = (0, u.getAriaRole)(e), n(this.accName, this.accDesc) && (this.accDesc = null)
    }
    Object.defineProperty(t, "__esModule", {
        value: !0
    }), t.InfoObject = void 0;
    ...
    function i(e, t) {
        var r = (0, l.getAttributeValue)(e, t),
            ...
            s = [];
        if (r.length)
            for (n = r.split(" "), o = 0; o < n.length; o++) a = document.getElementById(n[o]), a && (i = u(a, !0), i && i.name.length && s.push(i.name));
        return s.length ? {
            name: s.join(" "),
            source: t
        } : null
    ...
    var l = r(1),
        c = r(2);
    t.getGroupingLabels = o, t.nameFromNativeSemantics = a, t.getAccessibleName = u, t.getAccessibleDesc = s
}, function (e, t, r) {
    "use strict";
    ...
    function n(e, t, r) {
        ...
        s.setAttribute("class", [r, "oaa-element-overlay"].join(" ")), s.startLeft = t.left + n.x + "px", s.startTop = t.top + n.y + "px", s.style.left = s.startLeft, s.style.top = s.startTop, s.style.width = Math.max(t.width, o) + "px", s.style.height = Math.max(t.height, u) + "px", s.style.borderColor = e.color, s.style.zIndex = i;
        var l = document.createElement("div");
        return l.setAttribute("class", "oaa-overlay-label"), l.style.backgroundColor = e.color, l.innerHTML = e.label, s.appendChild(l), s
    }
