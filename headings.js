! function (e) {
    ...
    function n() {
        ...
        var t = [{
            ...
            n = {
                appName: "Headings",
                cssClass: (0, i.getCssClass)("Headings"),
                msgText: "No heading elements (" + r + ") found.",
                targetList: t,
                getInfo: e,
                dndFlag: !0
            };
        return new o.Bookmarklet(n)
    }
    var o = r(7),
        a = r(8),
        i = r(5),
        ...
        switch (e.nodeType) {
            case Node.ELEMENT_NODE:
                if (a(e)) r = o(e, "alt");
                    ...
                    for (var i = e.childNodes, s = [], c = 0; c < i.length; c++) {
                        var m = l(i[c], t);
                        m.length && s.push(m)
                    }
                    r = s.length ? s.join(" ") : ""
    ...
    var y = r(10);
    t.normalize = n, t.getAttributeValue = o, t.hasEmptyAltText = i, t.isLabelableElement = s, t.getElementContents = c, t.nameFromAttribute = d, t.nameFromAltAttribute = f, t.nameFromContents = b, t.nameFromDefault = p, t.nameFromDescendant = g, t.nameFromLabelElement = h, t.nameFromDetailsOrSummary = v
}, function (e, t, r) {
    "use strict";
    ...
    function a(e) {
        ...
        switch (t) {
            ...
            case "fieldset":
                return "group";
            case "footer":
                if (!(0, u.isDescendantOf)(e, ["article", "section"])) return "contentinfo";
                break;
            case "form":
                return "form";
            case "h1":
            ...
            case "hr":
                return "separator";
            case "img":
                if (!(0, l.hasEmptyAltText)(e)) return "img";
                break;
            case "input":
                ...
                break;
            case "li":
                if ((0, u.hasParentWithName)(e, ["ol", "ul"])) return "listitem";
                break;
            case "link":
                if (e.hasAttribute("href")) return "link";
                break;
            ...
            "function" == typeof e.filter && (t = Array.prototype.filter.call(t, e.filter)), Array.prototype.forEach.call(t, function (t) {
                if (n(t)) {
                    ...
                    var m = t.getBoundingClientRect(),
                        d = (0, l.createOverlay)(e, m, r);
                    i && (0, l.addDragAndDrop)(d);
                    var f = d.firstChild;
                    f.title = (0, c.formatInfo)(u), document.body.appendChild(d), s += 1
                }
            })
        }), s
    }
    ...
    var l = r(12),
        c = r(6);
    t.countChildrenWithTagNames = o, t.isDescendantOf = a, t.hasParentWithName = i, t.addNodes = s, t.removeNodes = u
}, function (e, t) {
    "use strict";
    ...
    function n(e) {
        ...
        if (e.hasAttribute("role")) {
            var s = (0, a.getAttributeValue)(e, "role");
            s.length && (r += ' [role="' + s + '"]')
        }
        return r
    }
//Where the text for the tooltip is generated
    ...
    function o(e) {
        ...
        var o = new u.MessageDialog;
        window.addEventListener("resize", function (e) {
            (0, s.removeNodes)(t.cssClass), o.resize(), t.show = !1
    ...
    t.Bookmarklet = o, o.prototype.run = function () {
        var e = new u.MessageDialog;
        e.hide(), this.show = !this.show, this.show ? 0 === (0, s.addNodes)(this.params) && (e.show(this.appName, this.msgText), this.show = !1) : (0, s.removeNodes)(this.cssClass)
    }
}, function (e, t, r) {
    "use strict";
    ...
    function o(e, t) {
        this.title = t, this.element = (0, i.getElementInfo)(e), this.grpLabels = (0, a.getGroupingLabels)(e), this.accName = (0, a.getAccessibleName)(e), this.accDesc = (0, a.getAccessibleDesc)(e), this.role = (0, s.getAriaRole)(e), n(this.accName, this.accDesc) && (this.accDesc = null)
    }
    Object.defineProperty(t, "__esModule", {
        value: !0
    }), t.InfoObject = void 0;
    ...
    function n(e) {
        function t(e, r) {
            ...
            if (n) {
                ...
                if (o) {
                    var a = (0, l.getElementContents)(o);
                    a.length && r.push({
                        name: a,
    ...
    function o(e) {
        return (0, l.isLabelableElement)(e) ? n(e) : []
    }
    ...
    function a(e, t) {
        ...
        switch (r) {
            case "input":
                switch (e.type) {
                    case "hidden":
                        t && (o = (0, l.nameFromLabelElement)(e));
                        break;
                    case "email":
                    case "password":
                    case "search":
                    ...
                    case "text":
                    case "url":
                        o = (0, l.nameFromLabelElement)(e), null === o && (o = (0, l.nameFromAttribute)(e, "placeholder"));
                        break;
                    case "button":
                        o = (0, l.nameFromAttribute)(e, "value");
                        break;
                    case "reset":
                        o = (0, l.nameFromAttribute)(e, "value"), null === o && (o = (0, l.nameFromDefault)("Reset"));
                        break;
                    case "submit":
                        o = (0, l.nameFromAttribute)(e, "value"), null === o && (o = (0, l.nameFromDefault)("Submit"));
                        break;
                    case "image":
                        o = (0, l.nameFromAltAttribute)(e), null === o && (o = (0, l.nameFromAttribute)(e, "value"));
                        break;
                    default:
                        o = (0, l.nameFromLabelElement)(e)
                }
                break;
            case "button":
                o = (0, l.nameFromContents)(e);
                break;
            case "label":
                o = (0, l.nameFromContents)(e);
                break;
            ...
            case "embed":
                ...
                break;
            case "iframe":
                o = (0, l.nameFromAttribute)(e, "title");
                break;
            case "img":
            case "area":
                o = (0, l.nameFromAltAttribute)(e);
                break;
            case "object":
                o = {
                    name: "NOT YET IMPLEMENTED",
                ...
                break;
            case "svg":
                o = (0, l.nameFromDescendant)(e, "title");
                break;
            case "video":
                o = {
                    name: "NOT YET IMPLEMENTED",
            ...
            case "a":
                ...
                break;
            case "details":
                o = (0, l.nameFromDetailsOrSummary)(e);
                break;
            case "figure":
                o = (0, l.nameFromDescendant)(e, "figcaption");
                break;
            case "table":
                o = (0, l.nameFromDescendant)(e, "caption");
                break;
            default:
                ((0, c.nameFromIncludesContents)(e) || t) && (o = (0, l.nameFromContents)(e))
        }
        return null === o && (o = (0, l.nameFromAttribute)(e, "title")), o
    }

    function i(e, t) {
        var r = (0, l.getAttributeValue)(e, t),
            n = void 0,
            o = void 0,
            a = void 0,
            i = void 0,
            u = [];
        if (r.length)
            for (n = r.split(" "), o = 0; o < n.length; o++) a = document.getElementById(n[o]), a && (i = s(a, !0), i && i.name.length && u.push(i.name));
        return u.length ? {
            name: u.join(" "),
            source: t
        } : null
    ...
    function s(e, t) {
        var r = null;
        return t || (r = i(e, "aria-labelledby")), null === r && (r = (0, l.nameFromAttribute)(e, "aria-label")), null === r && (r = a(e, t)), r
    }

    function u(e, t) {
        var r = null;
        return t || (r = i(e, "aria-describedby")), null === r && (r = (0, l.nameFromAttribute)(e, "title")), r
    }
    Object.defineProperty(t, "__esModule", {
        value: !0
    ...
    var l = r(1),
        c = r(2);
    t.getGroupingLabels = o, t.nameFromNativeSemantics = a, t.getAccessibleName = s, t.getAccessibleDesc = u
}, function (e, t, r) {
    "use strict";
    ...
    function n(e, t, r) {
        ...
        u.setAttribute("class", [r, "oaa-element-overlay"].join(" ")), u.startLeft = t.left + n.x + "px", u.startTop = t.top + n.y + "px", u.style.left = u.startLeft, u.style.top = u.startTop, u.style.width = Math.max(t.width, o) + "px", u.style.height = Math.max(t.height, s) + "px", u.style.borderColor = e.color, u.style.zIndex = i;
        var l = document.createElement("div");
        return l.setAttribute("class", "oaa-overlay-label"), l.style.backgroundColor = e.color, l.innerHTML = e.label, u.appendChild(l), u
    }
